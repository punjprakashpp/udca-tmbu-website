...
<asp:Content ID="ContentBody" ContentPlaceHolderID="Content" runat="Server">
    <section class="py-4 bg-light">
        <div class="container contain bg-white rounded shadow-sm p-4">
            ...
            <p>
                The <span class="text-danger">Central Library</span>, designated as the apex body of Tilka Manjhi Bhagalpur University's library system, serves as the cornerstone of academic resources. It houses an extensive collection of books, journals, and printed materials to support research and learning. Situated amidst a picturesque 4-acre expanse within the University's administrative campus, it not only collects and disseminates printed material but also serves as a hub for scholarly engagement and preservation efforts.
            </p>
