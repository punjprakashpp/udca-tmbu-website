...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <div class="container py-4">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body m-auto">
                <div class="row g-3 align-items-center">
                    <div class="col-auto">
                        <label for="txtSearch" class="form-label">Search using:</label>
                        </div>
                    <div class="col-auto">
                        <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" Placeholder="Enter search text"></asp:TextBox>
                    </div>
                    <div class="col-auto">
        ...
        <!-- Message Display -->
        <asp:Label ID="lblMessage" runat="server" CssClass="d-block text-center text-danger fw-bold mb-3"></asp:Label>
                    ...
                    <asp:TemplateField HeaderText="Date" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                        <EditItemTemplate>
                            <asp:TextBox
                                ID="txtNoticeDate"
                                runat="server"
                                CssClass="form-control form-control-sm flatpickr-input"
