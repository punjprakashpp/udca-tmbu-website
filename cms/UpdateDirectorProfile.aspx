<%@ Page Title="Update Director's Profile" Language="C#" MasterPageFile="cms.master" AutoEventWireup="true" CodeFile="UpdateDirectorProfile.aspx.cs" Inherits="UpdateDirectorProfile" %>
    ...
    <section class="py-4 bg-light">
        <div class="container bg-white rounded shadow-sm p-5" style="max-width: 720px;">
            ...
            <div class="row g-3">
                ...
                <div class="col-6">
                    <Label for="fileUploadDirectorProfile" class="form-label">Select Director Profile PDF:</Label>
