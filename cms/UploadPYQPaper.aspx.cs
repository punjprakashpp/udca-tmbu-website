...
public partial class UploadPYQPaper : System.Web.UI.Page
{
        ...
        try
            {                
                if (fileUpload.HasFile)
                {
                    ...
                    string fileName = "PYQ_"+ ddlSession.SelectedValue + "_" + ddlSemester.SelectedValue + (fileExtension == ".zip" ? ".zip" : ".pdf");

                    string uploadFolder = Server.MapPath("~/uploads/PYQ/");
                    ...
                    string relativeFilePath = "uploads/PYQ/" + fileName;
                    ...
                    using (SqlConnection conn = new SqlConnection(connStr))
                    {
                        ...
                        {
                            cmd.Parameters.AddWithValue("@Type", "PYQ");
                            cmd.Parameters.AddWithValue("@Title", "PYQ " + ddlSession.SelectedValue + " " + ddlSemester.SelectedValue);
    ...
    {
        Response.Redirect("ManagePYQPapers.aspx");
    }
}