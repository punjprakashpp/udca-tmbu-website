<%@ Page Title="Upload Internal Question" Language="C#" MasterPageFile="~/cms/cms.master" AutoEventWireup="true" CodeFile="UploadInternalQuestion.aspx.cs" Inherits="UploadInternalQuestion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <section class="py-5 bg-light">
        <div class="container contain bg-white rounded shadow-sm py-2 px-4">
            <h2 class="text-center text-primary rounded-top p-4 mb-4">Upload Internal Question Image/PDF</h2>
            <div class="mb-4">
                <div class="row">
