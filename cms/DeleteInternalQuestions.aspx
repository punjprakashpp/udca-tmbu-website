<%@ Page Title="Delete Internal Questions" Language="C#" MasterPageFile="~/cms/cms.master" AutoEventWireup="true" CodeFile="DeleteInternalQuestions.aspx.cs" Inherits="DeleteInternalQuestions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <div class="container py-4">
        <!-- Page Heading -->
        <h2 class="text-center mb-4">Delete Internal Questions</h2>
        ...
        <div class="table-responsive">
            <asp:GridView ID="gvNotice" runat="server" AutoGenerateColumns="False" DataKeyNames="DocsID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Session" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                        <ItemTemplate>
                            <asp:Label ID="lblNoticeDate" runat="server" Text='<%# Eval("Session") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Semester" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                        <ItemTemplate>
                            <asp:Label ID="lblNoticeDate" runat="server" Text='<%# Eval("Semester") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
