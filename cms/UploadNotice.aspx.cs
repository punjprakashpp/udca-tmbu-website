...
public partial class cms_UploadNotice : System.Web.UI.Page
{
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(noticeTitle))
        {
            try
            {
                ...
                if (fileUpload.HasFile)
                {
                    ...
                    string fileName = "Notice_" + safeNo + "_" + formattedDate + "_" + safeTitle + ".pdf";
                    ...
                    {
                        string query = "INSERT INTO Docs (Type, No, Title, Date, FilePath, UploadDate) VALUES (@Type, @No, @Title, @Date, @FilePath, @UploadDate)";
        ...
        {
            lblMessage.Text = "Please enter a valid Notice Title and Notice Date.";
            lblMessage.ForeColor = Color.Red;
        }
    }
