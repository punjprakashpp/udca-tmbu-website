<%@ Page Title="Upload Syllabus" Language="C#" MasterPageFile="~/cms/cms.master" AutoEventWireup="true" CodeFile="UploadSyllabus.aspx.cs" Inherits="UploadSyllabus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <section class="py-5 bg-light">
        <div class="container contain bg-white rounded shadow-sm py-2 px-4">
            <h2 class="text-center text-primary rounded-top p-4 mb-4">Upload Syllabus Image/PDF</h2>
            <div class="mb-4">
                <div class="row">
                    ...
                    <div class="col-md-4 text-center mb-2">
                        <label for="fileUpload" class="form-label">Select Image/PDF File :</label>
