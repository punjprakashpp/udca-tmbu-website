<%@ Page Title="Delete Modal Questions" Language="C#" MasterPageFile="~/cms/cms.master" AutoEventWireup="true" CodeFile="DeleteModalQuestions.aspx.cs" Inherits="DeleteModalQuestions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <div class="container py-4">
        <!-- Page Heading -->
        <h2 class="text-center mb-4">Delete Modal Questions</h2>
