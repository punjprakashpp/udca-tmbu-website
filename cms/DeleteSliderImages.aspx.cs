...
public partial class cms_DeleteSliderImages : System.Web.UI.Page
{
    ...
    private void BindGridView(string searchQuery = "")
    {
        ...
        {
            string query = "SELECT ImageID, Title, '~/' + FilePath AS FilePath FROM Image WHERE Type = 'Slider' ORDER BY UploadDate DESC";
