    ...
    <section class="py-4 bg-light">
        <div class="container bg-white rounded shadow-sm p-5" style="max-width: 720px;">
            ...
            <div class="row g-3">
                ...
                <!-- Save & Manage Buttons -->
                <div class="col-md-6">
                    <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-success mt-4" OnClick="btnSave_Click" />
                    <asp:Button ID="btnEdit" runat="server" Text="Manage" CssClass="btn btn-secondary ms-4 mt-4" OnClick="btnEdit_Click" />
                </div>
            </div>
        </div>
    </section>
