<%@ Page Title="Upload PYQ Paper" Language="C#" MasterPageFile="~/cms/cms.master" AutoEventWireup="true" CodeFile="UploadPYQPaper.aspx.cs" Inherits="UploadPYQPaper" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <section class="py-5 bg-light">
        <div class="container contain bg-white rounded shadow-sm py-2 px-4">
            <h2 class="text-center text-primary rounded-top p-4 mb-4">Upload Previous Year Question Paper Image/PDF</h2>
            <div class="mb-4">
                <div class="row">
