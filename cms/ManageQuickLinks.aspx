<%@ Page Title="Manage Qucik Links" Language="C#" MasterPageFile="~/cms/cms.master" AutoEventWireup="true" CodeFile="ManageQuickLinks.aspx.cs" Inherits="ManageQuickLinks" %>
    ...
    <div class="container py-4">
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <h2 class="text-center text-primary mb-4">Manage Quick Links for Buttons</h2>
                            ...
                            <tbody>
                                <tr>
                                    <td class="align-middle">
                                        <label for="txtSearch" class="form-label mb-0">Search Highlight Link:</label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" Placeholder="Enter link text"></asp:TextBox>
                                    </td>
                                    <td>
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <asp:GridView
                        ...
                        OnRowUpdating="gvLinks_RowUpdating"
                            ...
                            <asp:TemplateField HeaderText="Link URL">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:DropDownList
                                        ...
                                        AutoPostBack="true"
                                        OnSelectedIndexChanged="ddlLinkPicker_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </EditItemTemplate>
                                <ItemTemplate>
