<%@ Page Title="Delete PYQ Papers" Language="C#" MasterPageFile="~/cms/cms.master" AutoEventWireup="true" CodeFile="DeletePYQPapers.aspx.cs" Inherits="DeletePYQPapers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <div class="container py-4">
        <!-- Page Heading -->
        <h2 class="text-center mb-4">Delete Previous Year Question Papers</h2>
