<%@ Page Title="Manage Tenders" Language="C#" MasterPageFile="~/cms/cms.master" AutoEventWireup="true" CodeFile="ManageTenders.aspx.cs" Inherits="cms_ManageTenders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <div class="container py-4">
        <!-- Page Heading -->
        <h2 class="text-center mb-4">Manage Tenders</h2>
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body m-auto">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-auto">
                        <asp:RadioButton ID="rdTitle" runat="server" Text="Tender" GroupName="SearchCriteria" CssClass="form-check-input me-2 border-0" />
                    </div>
                    <div class="col-md-4">
