<%@ Page Title="Download Modal Papers" Language="C#" MasterPageFile="Site.master" AutoEventWireup="true" CodeFile="DownloadModalQuestions.aspx.cs" Inherits="DownloadModelPapers" %>
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="Content" runat="Server">
    <section class="py-5 bg-light">
        <div class="container contain bg-white rounded shadow-sm py-2 px-4">
            <h1 class="text-center text-primary rounded-top p-4 mb-4">Download Modal Papers</h1>
